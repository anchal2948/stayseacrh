...
<aside id="leftsidebar" class="sidebar">
    ...
    <div class="menu">
        <ul class="list">
            ...
            <!--<li><a href="{{ route('user.profile') }}"><i class="zmdi zmdi-account"></i><span>My Profile</span></a></li>-->
            <li><a href="{{ route('user.bookings') }}"><i class="zmdi zmdi-account"></i><span>My Bookings</span></a></li>
